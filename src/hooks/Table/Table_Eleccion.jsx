...
export default function TableEleccion({ elecciones }) {
  return (
    <Box sx={{ width: "100%" }}>
      <Sheet
        variant="outlined"
        ...
        >
          <thead>
            <tr>
              ...
              <th style={{ width: 150 }}>Convocatorias</th>
          ...
          <tbody>
            {elecciones.map((eleccion, index) => (
                  ...
                  <td>{eleccion.ACTIVO}</td>
                  <td>{"Convocatorias asociadas"}</td>
